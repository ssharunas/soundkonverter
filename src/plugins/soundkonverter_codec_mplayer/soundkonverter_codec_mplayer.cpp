                                          ...
                                          bool replayGain)
{
    ...
    connect(newItem->process, &KProcess::readyRead, this, &soundkonverter_codec_mplayer::processOutput);
    connect(newItem->process, &KProcess::finished, this, &soundkonverter_codec_mplayer::processExit);
