    ...
    , currentFormat("ape")
{
    ...
    connect(sCompressionLevel, &QSlider::valueChanged, this, &MacCodecWidget::compressionLevelSliderChanged);
    connect(sCompressionLevel, &QSlider::valueChanged, this, &MacCodecWidget::optionsChanged);
    ...
    connect(iCompressionLevel, &QSpinBox::valueChanged, this, &MacCodecWidget::compressionLevelSpinBoxChanged);
    connect(iCompressionLevel, &QSpinBox::valueChanged, this, &MacCodecWidget::optionsChanged);
