                                        ...
                                        bool replayGain)
{
    ...
    connect(newItem->process, &QProcess::readyRead, this, &soundkonverter_codec_speex::processOutput);
    connect(newItem->process, &QProcess::finished, this, &soundkonverter_codec_speex::processExit);
